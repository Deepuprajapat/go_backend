...
func (oc *OTPCreate) SetPhone(s string) *OTPCreate {
...
func (oc *OTPCreate) SetIsUsed(b bool) *OTPCreate {
	oc.mutation.SetIsUsed(b)
	return oc
}

// SetNillableIsUsed sets the "is_used" field if the given value is not nil.
func (oc *OTPCreate) SetNillableIsUsed(b *bool) *OTPCreate {
	if b != nil {
		oc.SetIsUsed(*b)
	}
	return oc
...
func (oc *OTPCreate) SetID(i int) *OTPCreate {
	oc.mutation.SetID(i)
	return oc
}
...
func (oc *OTPCreate) SetNillableUserID(id *int) *OTPCreate {
	if id != nil {
		oc = oc.SetUserID(*id)
	}
	return oc
...
func (oc *OTPCreate) defaults() {
	if _, ok := oc.mutation.IsUsed(); !ok {
		v := otp.DefaultIsUsed
		oc.mutation.SetIsUsed(v)
	}
}
...
func (oc *OTPCreate) check() error {
	if _, ok := oc.mutation.Phone(); !ok {
		return &ValidationError{Name: "phone", err: errors.New(`ent: missing required field "OTP.phone"`)}
	}
...
func (oc *OTPCreate) createSpec() (*OTP, *sqlgraph.CreateSpec) {
	...
	if value, ok := oc.mutation.IsUsed(); ok {
